<?php
// app/view/proveedores/proveedores_edit.php
                ...
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="m-0 dark-title">
                            <i class="fas fa-edit text-gold me-2"></i> Editar Proveedor
                        </h3>
                        <small style="color: rgba(255, 255, 255, 0.6) !important; display: block; margin-top: 4px;">
                            Actualice los datos del proveedor seleccionado
                        </small>
                    </div>
                    <div class="col-auto">
            ...
            <div class="dark-card card shadow-sm">
                <div class="card-header" style="background: #f8f9fa !important; border-bottom: 1px solid rgba(0,0,0,0.06) !important; border-radius: 16px 16px 0 0 !important; padding: 16px 20px !important;">
                    <h5 class="m-0" style="color: #1a1a2e !important; font-weight: 700 !important;">
                        <i class="fas fa-pen me-2"></i> Editar Proveedor #<?= htmlspecialchars($proveedor['id_proveedor'] ?? '') ?>
                    </h5>
                </div>
                    ...
                    <form method="POST" action="?url=proveedores&type=update">
                        ...
                        <div class="row g-3">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" id="razon_social" name="razon_social" class="form-control" 
                                               ...
                                               value="<?= htmlspecialchars($proveedor['razon_social'] ?? '') ?>" required>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" id="numero_contacto" name="numero_contacto" class="form-control" 
                                               ...
                                               value="<?= htmlspecialchars($proveedor['numero_contacto'] ?? '') ?>" required>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <input type="email" id="correo_electronico" name="correo_electronico" class="form-control" 
                                               ...
                                               value="<?= htmlspecialchars($proveedor['correo_electronico'] ?? '') ?>">
                                    </div>
                                    <div class="col-md-12">
                                        ...
                                        <textarea id="direccion" name="direccion" class="form-control" rows="2" 
                                                  ...
                                                  placeholder="Dirección fiscal o física del proveedor" required><?= htmlspecialchars($proveedor['direccion'] ?? '') ?></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- ==========================================
                                 ...
                                 ========================================== -->
                            <div class="col-12 text-center" style="border-top: 1px solid rgba(0,0,0,0.04); padding-top: 20px; margin-top: 10px;">
