<?php
// CAMBIO: Ajuste de nombre según BD - Vista de listado de categorías CON BOOTSTRAP
                            ...
                            <tr>
                                ...
                                <td class="pe-4 text-end">
                                    <div class="btn-group btn-group-sm">
                                        ...
                                        <!-- 🔥 FORMULARIO DE ELIMINAR CORREGIDO -->
                                        <form method="POST" action="?url=configuracion&type=delete" style="display:inline;" 
