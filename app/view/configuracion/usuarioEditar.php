                ...
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="m-0 dark-title">
                            <i class="fas fa-edit text-gold me-2"></i> Editar Usuario
                        </h3>
                        <small style="color: rgba(255, 255, 255, 0.6) !important; display: block; margin-top: 4px;">
                            Modifique los datos del usuario: <?= htmlspecialchars($usuario['nombre'] ?? '') ?>
                        </small>
                    </div>
                    <div class="col-auto">
            ...
            <div class="dark-card card shadow-sm">
                <div class="card-header" style="background: #1a1a2e !important; border-bottom: 1px solid rgba(255,255,255,0.05) !important; border-radius: 16px 16px 0 0 !important; padding: 16px 20px !important;">
                    <h5 class="m-0" style="color: #ffffff !important; font-weight: 700 !important;">
                        <i class="fas fa-user-edit me-2"></i> Datos del Usuario
                    </h5>
                </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <label for="clave" class="form-label" style="color: #1a1a2e; font-weight: 600; font-size: 0.85rem;">Nueva Contraseña</label>
                                        <input type="password" name="clave" id="clave" class="form-control" 
                                               placeholder="Dejar vacío para no cambiar"
                                               style="border-radius: 12px; padding: 12px 16px; border: 1.5px solid rgba(0,0,0,0.08);">
                                        <small style="color: #6c757d; font-size: 0.7rem;">Solo si desea cambiar la contraseña</small>
                                    </div>
                                    <div class="col-md-6">
